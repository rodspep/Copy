...
REM  (run_copier_real.bat). Verify logs\copier_real.log shows "MAIN/REAL · !! REAL ...".
...
echo [real] done. Check logs\copier_real.log + the real group for the REAL startup line.
endlocal
