...
REM listener feed, places/manages real orders on demo. vol 0.01, max-open 5, poll 2s.
cd /d C:\mt5-bot
set PYTHONUNBUFFERED=yes
"C:\mt5-bot\.venv\Scripts\python.exe" -X utf8 -m scripts.ug_copier --live --symbol XAUUSDm --poll 2
